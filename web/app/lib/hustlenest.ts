...
export type SettingsWorkspaceData = {
  ...
  appearance: { theme: "light" | "dark"; logo_alignment: "top-left" | "top-center" | "top-right" | "bottom-left" | "bottom-center" | "bottom-right"; logo_size: number; dashboard_sections: Array<{ key: string; label: string; visible: boolean; collapsed: boolean }> };

...
import type { HomeWorkspaceData, WorkspaceView } from "../lib/hustlenest";
...
export function HomeWorkspace({
  ...
  return (
    <div className="workspace home-page">
      ...
      <section className="metric-grid home-metrics" aria-label="Business summary">
      ...
      <section className="home-grid">
        <article className="home-card priority-card">
        ...
        <article className="home-card quick-card">
        ...
        <article className="home-card home-trend-card">
        ...
        <article className="home-card home-recent-orders">

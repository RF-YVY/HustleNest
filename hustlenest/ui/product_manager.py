...
from ..services import order_service, soft_delete_service
...
class ProductManagerDialog(QDialog):
    ...
    def _handle_product_delete(self) -> None:
        ...
        try:
            ...
            if not soft_delete_service.soft_delete_product(self._selected_product.id):
                self._show_message("Product could not be found.")
                return
        ...
        self._show_message("Product moved to trash.")
